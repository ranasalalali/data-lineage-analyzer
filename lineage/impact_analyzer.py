def trace_lineage_with_impact(
    df, initial_source_table, impacted_columns, lineage_graph, type_changes
):
    ...
    while queue:
        ...
        current_source_table_name = (
            current_source_table.split(".")[1]
            if len(current_source_table.split(".")) == 2
            else current_source_table
        )
